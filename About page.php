...
<head>
    ...
    <link rel="stylesheet" href="../on_the_go incident reporter/Assets/css/About Page.css">
...
<body>
        ...
        <header>
         ...
         <nav class="navigation">
            ...
            <a href="About page.php"class="active"> About Us </a>
     ...
     <div class="heading">
        <h1 >About Us</h1>
        <p> On_the_go incident report system App is being built to modernize the way incidents are reported, tracked, and investigated in the city. </P>
     </div>
